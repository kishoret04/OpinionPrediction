...
def add_general_args(args=None):
    ...
    # args.add_argument('--root_folder', type=str, default='/home/path/pathyang_code/news/news/outlets')#path_update
    args.add_argument('--root_folder', type=str, default= '/home/path/path_data/outlets') #path_update
    ...
    args.add_argument('--max_seq_len', type=int, default= 183) #new_path_update
    # args.add_argument('--max_title_len', type=int, default= 16)#path_update
    args.add_argument('--max_title_len', type=int, default= 12)#new_path_update
    args.add_argument('--max_comment_len', type=int, default= 172)#new_path_update
    ...
    args.add_argument('--input_examples', default='/disk2/path/path_data/outlets/NewYorkTimes/pickle_inputs/final_mergedexamples_dFP_mh15_rh15.pkl')
...
def add_model_args(args=None):
    ...
    args.add_argument('--hid_dim', type=int, default= 768)#path_update size = (768) BERT output
    ...
    args.add_argument('--freeze_bert', type=str2bool, default=True) #path_update
    args.add_argument('--sel_model', type=str, default= 'bert', choices = ['bert', 'electra']) #path_update
    args.add_argument('--accumulate_grad_batches', type=int, default= 1) #path_update
...
def add_train_args(args=None):
    ...
    args.add_argument('--path_checkpoint', type=str, default='/disk2/path')
    args.add_argument('--dataloader_num_workrs', type=int, default=8)#new_path_update
